...
#六、模型预测
##1.点预测
predict=read.csv("E:/github_repo/multiple-regression/result/predict.csv")
...
```
2015年GDP个值预测区间:(`r x0[1,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[1,])%*%solve((t(x)%*%x))%*%x0[1,])) `,`r x0[1,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[1,])%*%solve((t(x)%*%x))%*%x0[1,]))`);

2015年GDP均值预测区间：(`r x0[1,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(t(x0[1,])%*%solve((t(x)%*%x))%*%x0[1,])) `,`r x0[1,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(t(x0[1,])%*%solve((t(x)%*%x))%*%x0[1,]))`);

2016年GDP个值预测区间:(`r x0[2,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[2,])%*%solve((t(x)%*%x))%*%x0[2,])) `,`r x0[2,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[2,])%*%solve((t(x)%*%x))%*%x0[2,]))`);

2016年GDP均值预测区间:(`r x0[2,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(t(x0[2,])%*%solve((t(x)%*%x))%*%x0[2,])) `,`r x0[2,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(t(x0[2,])%*%solve((t(x)%*%x))%*%x0[2,]))`);

2016年GDP个值预测区间:(`r x0[3,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[3,])%*%solve((t(x)%*%x))%*%x0[3,])) `,`r x0[3,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(1+t(x0[3,])%*%solve((t(x)%*%x))%*%x0[3,]))`);

2016年GDP均值预测区间:(`r x0[3,]%*%beta+qt(0.975,df=21)*sqrt(sigma^2*(t(x0[3,])%*%solve((t(x)%*%x))%*%x0[3,])) `,`r x0[3,]%*%beta-qt(0.975,df=21)*sqrt(sigma^2*(t(x0[3,])%*%solve((t(x)%*%x))%*%x0[3,]))`).
