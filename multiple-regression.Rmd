...
要求：以国内生产总值(亿元)(y)为因变量，固定资产投资(亿元)(x1)、就业人数(万人(x2)和社会消费品零售总额(亿元)
(x3)为自变量，拟合影响国内生产总值的多元回归方程，并对回归方程进行检验，并解释模型的经济意义。
...
设回归模型为：$y_t = {\beta_0} + {\beta_1}x_1 + {\beta_2}x_2 + {\beta_3}x_3 + \varepsilon_t $ ，
